...
def main():
    ...
    tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["Initial Data Extraction", "Streamlit Application Core", "About Page", "Data and Visual Page", "Project Details Page", "Project Code Page"])
    with tab1:
    ...
    with tab2:
        app_data_url = 'https://raw.githubusercontent.com/stone-rose32/ECON-8320-Final-Project/main/streamlit_app.py'
        data_code = get_data(app_data_url)
        st.header('Streamlit Application Core Code')
        st.code(data_code, language='python')
    with tab3:
        app_data_url = 'https://raw.githubusercontent.com/stone-rose32/ECON-8320-Final-Project/main/pages/about.py'
        data_code = get_data(app_data_url)
        st.header('About Page Code')
        st.code(data_code, language='python')
    with tab4:
        app_data_url = 'https://raw.githubusercontent.com/stone-rose32/ECON-8320-Final-Project/main/pages/data_and_visuals.py'
        data_code = get_data(app_data_url)
        st.header('Introdution Page Code')
        st.code(data_code, language='python')
    with tab5:
        app_data_url = 'https://raw.githubusercontent.com/stone-rose32/ECON-8320-Final-Project/main/pages/project_details.py'
        data_code = get_data(app_data_url)
